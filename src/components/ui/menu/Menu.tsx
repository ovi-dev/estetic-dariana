    ...
    <nav className="relative bg-gray-900 text-white p-4">
      <ul className="flex space-x-6">
        <li className="relative group">
          ...
          {/* Submenú */}
          <ul
            className={`absolute left-0 mt-2 bg-gray-800 shadow-lg rounded-md w-48 transition-opacity duration-300 ${
              open ? "opacity-100 visible" : "opacity-0 invisible"
            } group-hover:opacity-100 group-hover:visible`}
          >
            <li className="px-4 py-2 hover:bg-gray-700">Diseño Web</li>
            <li className="px-4 py-2 hover:bg-gray-700">Desarrollo</li>
            <li className="px-4 py-2 hover:bg-gray-700">Marketing</li>
          </ul>
        </li>

        <li>
          <a href="#" className="px-4 py-2 hover:bg-gray-700 rounded-md">
            Contacto
          </a>
        </li>
      </ul>
